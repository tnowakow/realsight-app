...
// Helper component to prevent repetition
...
export const OverviewTab = () => {
  ...
  const tooltips = {
    collectionRate: <span><strong>Rent Collection Rate:</strong> % of total rent due that was collected.</span>,
    occupancy: <span><strong>Portfolio Occupancy:</strong> % of rentable units with an active lease.</span>,
    outstanding: <span><strong>Total Outstanding:</strong> Total unpaid rent.</span>,
    daysPastDue: <span><strong>Avg. Days Past Due:</strong> Average for late tenants only.</span>,
    monthlyRevenue: <span><strong>Monthly Revenue:</strong> Gross potential income for the month.</span>,
    problemTenants: <span><strong>Problem Tenants:</strong> Count of tenants who are >15 days late or have a problem status.</span>,
    activeAlerts: <span><strong>Active Alerts:</strong> Count of tenants with 'critical' or 'high' severity status.</span>,
    noiMargin: <span><strong>NOI Margin (Est.):</strong> Estimated Net Operating Income margin (assumes 35% OpEx).</span>,
  };
